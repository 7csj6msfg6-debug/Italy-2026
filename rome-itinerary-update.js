(() => {
  ...
  setDay('2026-09-20', 'Rome arrival, historic center and Trastevere food tour', [
    ...
    {time:'1:30–2:15 PM',title:'Hotel reset',note:'Rest, freshen up and get settled after the train ride.'},
    {time:'2:20–2:35 PM',title:'Largo di Torre Argentina',note:'Short visit close to the hotel before continuing toward Piazza di Spagna.',map:'https://www.google.com/maps/search/?api=1&query=Largo+di+Torre+Argentina+Rome'},
    {time:'~2:35–3:00 PM',title:'Head to Angie’s near Piazza di Spagna',note:'Walk or take a short taxi toward Piazza Mignanelli. The itinerary is a visual guide, so use whichever transfer makes the day feel easiest.',map:'https://www.google.com/maps/dir/?api=1&origin=Largo+di+Torre+Argentina+Rome&destination=Angie%27s+Restaurant+Piazza+Mignanelli+21a+Rome'},
    {time:'3:00–3:20 PM',title:'🥂 Complimentary Proseccos at Angie’s',note:'Redeem the 2 complimentary glasses of Prosecco included with the Big Bus booking at Angie’s Restaurant, Piazza Mignanelli 21a. Valid today only. Treat this as a quick drink stop, not a meal.',status:'Booked',map:'https://www.google.com/maps/search/?api=1&query=Angie%27s+Restaurant+Piazza+Mignanelli+21a+Rome'},
    {time:'3:35–4:05 PM',title:'Pantheon',note:'Visit the Pantheon interior if ticket/entry timing works, then continue toward Piazza Navona.',map:'https://www.google.com/maps/search/?api=1&query=Pantheon+Rome'},
    {time:'4:10–4:35 PM',title:'Piazza Navona',note:'Enjoy the fountains and surrounding streets without adding extra stops that would cut into the food-tour buffer.',map:'https://www.google.com/maps/search/?api=1&query=Piazza+Navona+Rome'},
  ...
  setDay('2026-09-23', 'North-Central Rome, Jewish Ghetto and Aventine', [
    ...
    {time:'11:15–11:45 AM',title:'Walk toward Trevi / free central Rome time',note:'Use the extra time for an unhurried walk through the center, photos or a quick shop stop before Trevi Fountain.'},
