...
function foodCategoryOrder(category){return ({Coffee:1,Breakfast:2,Lunch:3,Gelato:4,Dessert:5,Bar:6,Dinner:7})[category]||20}
...
function renderGuide(){
  ...
  const renderPlaces=()=>{
    ...
    if(sorted.length&&['Venice','Florence'].includes(activeCity)&&!placeSearch){
      const dateRange=activeCity==='Venice'?'September 15–16':'September 17–19';
      ...
      const dayTitle=date=>({
        '2026-09-15':'Arrival Day','2026-09-16':'Tour Day','2026-09-17':'Arrival Day','2026-09-18':'Museum Day','2026-09-19':'Pisa & Wine Tour'
      })[date]||'';
